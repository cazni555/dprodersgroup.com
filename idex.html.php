...
<head>
    ...
    <script src="https://kit.fontawesome.com/2479f1af86.js" crossorigin="anonymous"></script>
                       ...
                       if($result){
                           ...
                           while ($row = mysqli_fetch_assoc($result)){ ?>
                               ...
                               <tr>
                                   ...
                                   <td data-id="<?php echo $row['id']; ?>"><?php echo 'Php' . $row['book_price']; ?></td>
...
<div class="text-center">
    <font color="White"><font size="6">GROUP ONE</font></p>
        <p align="center"><font color="White"><font size="5">BSIT-2B</font></p>
      </div>

<div class="text-center">
        <fonr color="Black"><p>IPT101 FINAL REQUIREMENT </p>
        </div>
